...
const {register,login,logout,adminRegister,deleteProfile,verifyOtp,resendOtp,forgotPassword,resetPassword,refreshAccessToken} = require("../controllers/userAuthent")
